...
for ix, i in tornados.iterrows():
    ...
    fig.add_annotation(
        text=f"<a href='https://beaconcha.in/block/{i['block_number']}' style='opacity:0;font-size:30px'>.</a>",
        font=dict(size=50),
        x=_x,
        y=_y,
        showarrow=False,
...
<meta property="og:image" content="https://toniwahrstaetter.com/map1.png">

<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:image" content="https://toniwahrstaetter.com/map1.png">
...
<meta property="twitter:url" content="https://tornado-warning.info/"><meta name="twitter:title" content="Ethereum Tornado Warnings">
...
what = '<div style="padding-top: 3%;max-width:800px"><p class="faq1" style=" font-weight:bold;color:#0A0F14">What is this all about?</p>'
iss = '<p class="faq" style="margin-top:-15px;padding-bottom: 25px;">The map shows the existing MEV Boost relays and the MEV-boosted blocks of the last {} {} that contained Tornado Cash transactions. While some relays take measures to prevent the terrible consequences of a tornado, others are exposed to them without any protection.</p>'.format(DAYS, _days)

this = '<p class="faq1" style=" font-weight:bold;color:#0A0F14;">Why aren`t there tornados at every relay?</p>'
stuff = '<p class="faq" style="margin-top:-15px;padding-bottom: 25px;">Some relays operate under the guidance of the OFAC. This protects them from tornados!</p>'

effec = '<p class="faq1" style=" font-weight:bold;color:#0A0F14">What are the effects of tornados?</p>'
expla = '<p class="faq" style="margin-top:-15px;padding-bottom: 25px;">Tornados kick up a lot of dust, so observers often can`t identify the victims. Uprooted merkle trees fly through the air. A horrible scenario. Survivors often have zero knowledge what happened.</p>'


quali = '<p class="faq1" style=" font-weight:bold;color:#0A0F14">What qualifies as a tornado?</p>'
ans = '<p class="faq" style="margin-top:-15px;padding-bottom: 25px;">Every block including a transaction that interacted with the ETH, DAI, USDC, USDT, cDai or wBTC contracts of Tornado Cash, no matter which denomination, plus TORN Transfers (mainnet only).</p>'


learn = '<p class="faq1" style=" font-weight:bold;color:#0A0F14">What`s the message?</p>'
yeah = '<p class="faq" style="margin-top:-15px;padding-bottom: 25px;">🏴&nbsp;Censorship-resistance must remain a core value.&nbsp;🏴</p>'
end = '</div>'
...
love = '<div style="padding-top: 5%;font-weight:bold;padding-bottom: 5%;max-width:800px;"><p class="footer">Built with 🖤 by '\
    + '<a href="https://github.com/Nerolation">Toni Wahrstätter</a></p>'\
    +'<p class="footer">View Source on <a href="https://github.com/Nerolation/eth-tornado-warning">Github</a></p></div>'
...
with open(PROJECT+"tornadohtml.html", "r") as file:
    ...
    f = f.replace("<body>", "<body style='font-family: Courier New, monospace;max-width: 1280px;width: 100%;margin-left: auto;margin-right: auto;background-color:#80a2d6'> <center>" + add+add2+add3)    
